        ...
        return (
            <div className="container">
                <Modal.Header closeButton>
                    <Modal.Title>Formulaire de création de compte</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                ...
                <Modal.Footer>
                    <button type="submit" className="btn btn-success btn-block col-sm-6 col-sm-offset-3" onClick={this.goRegister} >Créer mon compte</button>
                </Modal.Footer>
            </div>
